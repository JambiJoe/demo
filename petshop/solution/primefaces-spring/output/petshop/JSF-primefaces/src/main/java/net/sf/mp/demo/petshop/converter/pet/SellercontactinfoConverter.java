...
/**
 *
 * <p>Title: SellercontactinfoConverter</p>
 *
 * <p>Description: JSF converter SellercontactinfoConverter </p>
 *
 */
@FacesConverter(value="sellercontactinfoConverter")
@Component ("sellercontactinfoConverter")
public class SellercontactinfoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent ui, String value) {
	    ...
	    sellercontactinfo.setContactinfoid(java.lang.Integer.valueOf(value));
    ...
    public String getAsString(FacesContext context, UIComponent ui, Object object) {
		if (object==null)
            return "";
		return ((Sellercontactinfo) object).getContactinfoid().toString();
    }
