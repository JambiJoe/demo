...
/**
 *
 * <p>Title: MyGoodProductConverter</p>
 *
 * <p>Description: JSF converter MyGoodProductConverter </p>
 *
 */
@FacesConverter(value="myGoodProductConverter")
@Component ("myGoodProductConverter")
public class MyGoodProductConverter implements Converter {


    @Override
    public Object getAsObject(FacesContext context, UIComponent ui, String value) {
        MyGoodProduct myGoodProduct = new MyGoodProduct();
	    myGoodProduct.setProductid(value);
    ...
    public String getAsString(FacesContext context, UIComponent ui, Object object) {
		if (object==null)
            return "";
		return ((MyGoodProduct) object).getProductid().toString();
    }
