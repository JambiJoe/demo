...
/**
 *
 * <p>Title: GetAddressSummaryServiceImpl</p>
 *
 * <p>Description: SDD Spring service implementation </p>
 *
 */
@Service ("getAddressSummaryService")
@Transactional
public class GetAddressSummaryServiceImpl implements GetAddressSummaryService{
    @Autowired
    @Qualifier("getAddressSummaryDaoFace")
    GetAddressSummaryDaoFace getAddressSummaryDaoFace;
    
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @SDD_EXECUTE_GET-get address summary@
    public GetAddressSummaryOutList execute () {
        return getAddressSummaryDaoFace.execute ();
    }
