...
*/
package net.sf.mp.demo.petshop.dao.face;
...
@ContextConfiguration(locations={
     "classpath:net/sf/mp/demo/petshop/factory/spring/spring-config-Petshop-BE-main.xml"
})
@TransactionConfiguration(transactionManager = "petshopTransactionManager") 
@Transactional
public class AdapterPetshopTestDao extends AbstractTransactionalJUnit4SpringContextTests { 

	@Override
	@Autowired
	public void setDataSource(@Qualifier(value = "petshopDataSource") DataSource dataSource) {
