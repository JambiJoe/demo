...
@ContextConfiguration(locations={
     "classpath:net/sf/mp/demo/petshop/factory/spring/Petshop-service-application-context.xml"
})
@TransactionConfiguration(transactionManager = "petshopTransactionManager") 
@Transactional
public class AdapterPetshopTestService extends AbstractTransactionalJUnit4SpringContextTests { 
