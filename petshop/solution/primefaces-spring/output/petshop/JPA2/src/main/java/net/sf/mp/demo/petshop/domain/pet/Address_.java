...
public class Address_ {
    ...
    public static volatile SingularAttribute<Address, java.math.BigDecimal> latitude;
    public static volatile SingularAttribute<Address, java.math.BigDecimal> longitude;


    public static volatile SetAttribute<Address, MyGoodItem> myGoodItems;
